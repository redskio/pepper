# -*- coding: utf-8 -*-
"""
CleverTap 한국어 제안서 v5 — 이미지 컨텍스트 완전 교정판
- 각 슬라이드에 실제 해당 기능 UI 이미지 사용
- Analytics: Customer Data and Analytics 섹션 (product page)
- A/B: Experimentation & Optimization 제품 기능 그리드
- Fintech: Financial Services/Banking/Fintech 전용 페이지
"""
import sys, io
...
OUTPUT = Path("C:/Agent/pepper/output/clevertap_proposal_kr_v5.pptx")
