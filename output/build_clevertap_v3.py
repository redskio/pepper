...
def build():
    ...
    add_img(sl, ASSETS/"screenshot_main.png", IMG_X, IMG_Y, IMG_MAX_W, IMG_MAX_H)
    img_caption(sl, "CleverTap 공식 홈페이지", IMG_X, IMG_Y + IMG_MAX_H + Inches(0.05), IMG_MAX_W)
    print("  [3] 소개")
    ...
    add_img(sl, ASSETS/"screenshot_customers.png", IMG_X, IMG_Y, IMG_MAX_W, IMG_MAX_H)
    img_caption(sl, "CleverTap 핀테크 고객사 현황",
                IMG_X, IMG_Y + IMG_MAX_H + Inches(0.05), IMG_MAX_W)
    print("  [12] 핀테크")
